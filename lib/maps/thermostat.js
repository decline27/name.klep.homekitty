module.exports = (Mapper, Service, Characteristic) => ({
  ...
  required: {
    target_temperature: {
      ...Mapper.Characteristics.Temperature.Target,
      set: (value, { device, service, capability }) => {
        const opts = device.capabilitiesObj && device.capabilitiesObj.target_temperature;
        if (opts) {
        ...
        return Mapper.Characteristics.Temperature.Target.set(value, { device, service, capability });
      }
    },
